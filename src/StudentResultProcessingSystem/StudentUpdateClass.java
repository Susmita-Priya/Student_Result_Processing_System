...
public class StudentUpdateClass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/StudentResultProcessingSystem/Wallpaper20160706_020339.jpeg"))); // NOI18N
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        try {
            ...
            String query ="UPDATE studentinfom SET name='"+n+"',email='"+e+"',session='"+s+"',gender='"+g+"',password="+Pass1+",conformpassword="+Pass2+" WHERE id="+id;
